...
public enum Copy {
    ...
    public enum Wizard {
        ...
        public static let step8Title       = "약속금 확인"
        public static let step8SubDev      = "지금은 개발 모드예요. 실제 결제는 진행되지 않아요."
        public static let step8CTA         = "결제하고 계속"
        ...
        public static let step10SubMoney   = "이번 주 최대"
